...
class HomeController extends AbstractController
{
    ...
    #[Route('/filedownload/notificationletter/{filename}', name: 'download_notificationletter')]
    public function downloadNotificationLetter(string $filename): Response
    {
        if (!is_null($this->getUser()) && !$this->getUser()->isActivated()) {
            return $this->redirectToRoute("deactivated");
        }
        ...
        if (!in_array("ROLE_TEACHER", $this->getUser()->getRoles()) && !in_array("ROLE_ADMIN", $this->getUser()->getRoles())) {
