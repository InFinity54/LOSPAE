 ...
 */
final class Version20240304161248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note_change (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, criteria_id INT NOT NULL, impact DOUBLE PRECISION NOT NULL, occured_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5885A9F4CB944F1A (student_id), INDEX IDX_5885A9F4990BEA15 (criteria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
